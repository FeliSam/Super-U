...
export const exploreCategories: ExploreCategory[] = [
  { id: 'fruits-legumes', title: 'Fruits & Légumes', image: require('../assets/images/catalog/cat-fruits.png'), flex: 208, height: 168, tone: 'produce' },
  { id: 'viandes', title: 'Viandes & Volailles', image: require('../assets/images/catalog/cat-viandes.png'), flex: 138, height: 168 },
  { id: 'charcuterie', title: 'Charcuterie', image: require('../assets/images/catalog/cat-viandes.png'), flex: 138, height: 148 },
  { id: 'poissons', title: 'Poissons & Fruits de mer', image: require('../assets/images/catalog/cat-poissons.png'), flex: 138, height: 148 },
  { id: 'surgeles', title: 'Surgelés', image: require('../assets/images/catalog/glace-assortiment.png'), flex: 208, height: 148 },
  { id: 'laitiers', title: 'Produits laitiers', image: require('../assets/images/catalog/cat-laitiers.png'), flex: 208, height: 148 },
  { id: 'oeufs', title: 'Œufs', image: require('../assets/images/catalog/poulet.png'), flex: 138, height: 148 },
  { id: 'boulangerie', title: 'Boulangerie & Pâtisserie', image: require('../assets/images/catalog/cat-boulangerie.png'), flex: 138, height: 156 },
  { id: 'petit-dej', title: 'Petit-déjeuner', image: require('../assets/images/catalog/miel.png'), flex: 208, height: 156 },
  { id: 'cafe-the', title: 'Café & Thé', image: require('../assets/images/catalog/glace-cafe.png'), flex: 138, height: 156 },
  { id: 'feculents', title: 'Riz, pâtes & farines', image: require('../assets/images/catalog/cuisine-riz.png'), flex: 208, height: 156 },
  { id: 'huiles', title: 'Huiles, sauces & cubes', image: require('../assets/images/catalog/cat-epicerie.png'), flex: 138, height: 148 },
  { id: 'epices', title: 'Épices', image: require('../assets/images/catalog/circle-epices.png'), flex: 138, height: 148 },
  { id: 'conserves', title: 'Conserves', image: require('../assets/images/catalog/cat-poissons.png'), flex: 208, height: 148 },
  { id: 'epicerie', title: 'Épicerie sucrée', image: require('../assets/images/catalog/cat-epicerie.png'), flex: 138, height: 148 },
  { id: 'snacking', title: 'Snacking', image: require('../assets/images/catalog/plantains.png'), flex: 208, height: 156 },
  { id: 'boissons', title: 'Boissons', image: require('../assets/images/catalog/cat-boissons.png'), flex: 208, height: 156 },
  { id: 'alcools', title: 'Bières & vins', image: require('../assets/images/catalog/cat-boissons.png'), flex: 138, height: 156 },
  { id: 'bio', title: 'Bio & diététique', image: require('../assets/images/catalog/cat-fruits.png'), flex: 208, height: 156 },
  { id: 'cuisine', title: 'Produits déjà cuisinés', image: require('../assets/images/catalog/cat-cuisine.png'), flex: 208, height: 168 },
  { id: 'glaces', title: 'Glaces & Sorbets', image: require('../assets/images/catalog/cat-glaces.png'), flex: 138, height: 168 },
  { id: 'hygiene', title: 'Hygiène & Beauté', image: require('../assets/images/catalog/cat-hygiene.png'), flex: 208, height: 148 },
  { id: 'maison', title: 'Maison & Entretien', image: require('../assets/images/catalog/cat-maison.png'), flex: 208, height: 156 },
  { id: 'bebe', title: 'Bébé & Enfant', image: require('../assets/images/catalog/cat-bebe.png'), flex: 138, height: 156 },
  { id: 'animalerie', title: 'Animalerie', image: require('../assets/images/catalog/cat-maison.png'), flex: 208, height: 156 },
];
