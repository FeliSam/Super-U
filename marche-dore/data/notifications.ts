...
export const notifications: AppNotification[] = [
  ...
  },
  {
    ...
    body: 'Bonne nouvelle ! Votre commande #MD-2024-0847 est en préparation au Marché Doré Plateau. Livraison estimée aujourd’hui entre 14h et 16h à Dakar, Plateau.',
    time: 'Il y a 1 h',
    read: false,
    icon: 'package',
  ...
  },
  {
    ...
    body: 'Préparez la rentrée sereinement avec notre sélection : goûters, produits laitiers et articles pour bébé & enfant. Livraison rapide sur Dakar Plateau.',
    time: 'Lundi',
    read: true,
    icon: 'gift',
  },
