...
/**
 * Marché Doré type system — one family (DM Sans).
 * Headers use the same face, distinguished by weight / size / tracking.
 */
...
/** Titles / headers: same family as body, distinguished only by weight. */
