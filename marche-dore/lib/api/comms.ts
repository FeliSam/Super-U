...
export type InboxThread = {
  ...
  last_at: string | null;
  unread: number;
  peer_first?: string | null;
  peer_last?: string | null;
  peer_phone?: string | null;
  peer_staff_id?: string | null;
  peer_has_photo?: boolean | string | number;
...
export async function sendCommsMessage(id: string, body: string) {
...
export async function ensureSupportThread() {
  return apiFetch<{ ok: true; id: string }>('/comms/support/ensure', { method: 'POST' });
}
...
export async function registerCommsDevice(
