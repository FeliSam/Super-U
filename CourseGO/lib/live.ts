 ...
 *
 * Transport : SSE (`/ops/stream-ticket` puis `/ops/stream?ticket=`), avec EventSource sur le web
 * et un XMLHttpRequest lu au fil de l'eau sur iOS / Android. Si le SSE échoue deux fois de suite (proxy, réseau
 * mobile qui coupe), bascule en long-poll `/ops/events?since=&wait=25`, puis retente le SSE plus tard.
